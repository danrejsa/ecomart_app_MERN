...
class PostFarmProduct extends Component {
    state = { customerId:"",
    name: "",
    email: "",
    item_location: "",
...
render() { 
  ...
  //Manufacturer is the Product Name
        ...
        {isAuthenticated? 
        <Fragment>       
        <h3 className='post-title'>Post Farm Products </h3>
        <Form
        ...
        >
          ...
          <FormGroup>
            ...
            <Input
              ...
              id="manufacturer"
              value={manufacturer}
              placeholder='(e.g Local Rice, Jamakel Beans, Irish Pototo, Sweet Pototo)'
            >
          ...
          <FormGroup>
            ...
            <Input
              ...
              name="quantity"
              id="quantity"
              placeholder='(e.g 10 bags, 4 cartons)'
              value={quantity}
            />
          </FormGroup>
          <FormGroup>
